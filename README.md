...
For a long time, the options were: give up that day job and learn to write, somehow find the time alongside everything else, or leave the stories unwritten. I chose a fourth option. I use AI as a collaborative partner to bring these stories to life in the same way as I now use AI to supplement my coding.
...
You can browse the stories directly here on GitHub, or visit the companion website for a cleaner reading experience:

**[Read the stories here →](https://PanacheSoftwareDev.github.io/unwritten/)**
